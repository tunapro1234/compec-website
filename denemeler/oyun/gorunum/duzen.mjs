...
${OLCUM_ANAHTARI ? html`
<script>window.COMPEC_OLCUM={anahtar:${ham(JSON.stringify(OLCUM_ANAHTARI))},sunucu:${ham(JSON.stringify(OLCUM_SUNUCU))},surum:"v6-oyun"${s.kisi ? ham(`,kisi:${JSON.stringify('uye-' + s.kisi.id)},rol:${JSON.stringify(s.kisi.rol)}`) : ''}};</script>
...
<header class="tepe">
  <div class="kap tepe-ic">
    <a class="arma" href="${u('/')}">
      ...
      <img class="arma-yazi" src="${u('/genel/varliklar/logo/compec-wordmark-beyaz.png')}" alt="Compec" width="786" height="185">
    </a>
    ...
    <div class="dip-izgara">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="${u('/kimlerle')}">Konuşmacı arşivi</a></li>
          <li><a href="${u('/oduller')}">Bilişim Ödülleri arşivi</a></li>
          <li><a href="${u('/kanit')}">Rakamlar ve kaynakları</a></li>
