...
/* ============================ ÖĞRENCİLER ============================ */
export function ogrenciler({ kisi, konusmacilar, geziler, biletler, kurumSayisi }) {
  const icerik = html`
<section class="giris">
  <div class="kap">
    <div class="giris-izgara">
      <div>
        <h1>Diploma herkeste var.<br><i>Tanıdık herkeste yok.</i></h1>
        <p class="giris-ozet">
          Boğaziçi'nde iyi not almak zor değil. Zor olan, iyi not aldığını birinin
          bilmesi. COMPEC'in işi bu: seni sektörle aynı odaya sokmak, sonra o odayı
          senin kurmanı sağlamak. Üyelik ücretsiz, bahane yok.
        </p>
        <div class="giris-eylem">
...
<section class="bolum">
  <div class="kap">
    <div class="bas">
      <div><h2>Ne kazanırsın</h2></div>
      <div class="yan">Dört somut şey</div>
    </div>
...
<section class="bolum" style="padding-top:0">
  <div class="kap">
    <div class="bas">
      ...
      <div class="yan">2018 kaydı</div>
    </div>
    <div class="gezi">${geziler.map((g) => html`<span>${g.kurum}</span>`)}</div>
    <p class="mono" style="margin-top:16px">Kaynak: Youthall etkinlik kaydı · <a href="${u('/kanit')}">doğrulama durumu</a></p>
  </div>
</section>
...
<section class="bolum" style="padding-top:0">
  <div class="kap">
    <div class="bas">
      ...
      <div class="yan">geçmiş baskılar</div>
    </div>
    <div class="liste">
      ${biletler.map((b) => html`
        <div class="satir">
          <div class="satir-yan">${b.iddia.split(', ').slice(-1)[0]}</div>
          <div><h3>${b.deger}</h3><p>${b.iddia}</p></div>
          <div class="satir-veri"><span>${b.kaynak || ''}</span></div>
        </div>`)}
    </div>
  </div>
</section>
<section class="bolum">
  <div class="kap">
    <div class="bas">
      ...
      <div class="yan"><a href="${u('/kimlerle')}">Tüm kadro</a></div>
    </div>
    <div class="tanimlar">
      ${konusmacilar.map((k) => html`
        <div class="tanim">
...
<section class="giris">
  <div class="kap">
    <div class="giris-izgara">
      <div>
        <h1>Aradığınız ekip <i>henüz mezun olmadı.</i></h1>
        <p class="giris-ozet">
          İşe almak istediğiniz profil kampüsten çıkmadan önce burada. COMPEC 1994'ten
          beri bu öğrencileri bir araya getiriyor ve etkinlikleri onlar düzenliyor.
          Sponsorluk bir logoyu duvara asmak değil, o salona girmek. Aşağıdaki her
          rakamın kaynağı yazılı.
        </p>
        <div class="giris-eylem">
