...
function baglantilar(k) {
  ...
  if (!p.length) p.push(html`<span class="yok" style="display:inline-flex;align-items:center;gap:6px;font-family:var(--mono);font-size:11.5px;border:1px dashed var(--cizgi-koyu);border-radius:3px;padding:4px 9px;color:var(--murekkep-3)">Bağlantı eklenmemiş</span>`);
  return p;
}
...
<section class="bolum">
  <div class="kap">
    ...
    ${liste.length === 0
      ? html`<p style="color:var(--murekkep-2)">Bu ölçütlere uyan kayıt yok.</p>`
  ...
  <div class="kap">
    ...
    <div class="kisi-ust">
      ...
      <div>
        ...
        ${k.hakkinda ? html`<p style="margin-top:18px;color:var(--murekkep-2);max-width:56ch">${k.hakkinda}</p>` : ''}
