...
${OLCUM_ANAHTARI ? html`
<script>window.COMPEC_OLCUM={anahtar:${ham(JSON.stringify(OLCUM_ANAHTARI))},sunucu:${ham(JSON.stringify(OLCUM_SUNUCU))},surum:"v7-ufuk"${s.kisi ? ham(`,kisi:${JSON.stringify('uye-' + s.kisi.id)},rol:${JSON.stringify(s.kisi.rol)}`) : ''}};</script>
...
<header class="tepe">
  <div class="kap tepe-ic">
    ...
    <div class="tepe-hesap">
      ${k
        ? html`<a href="${u('/panel')}" style="font-size:15px;text-decoration:none;color:var(--metin-2)">${k.ad.split(' ')[0]}</a>
               <a class="dugme sade" href="${u('/cikis')}">Çıkış</a>`
        : html`<a href="${u('/giris')}" style="font-size:15px;text-decoration:none;color:var(--metin-2)">Giriş</a>
