...
${OLCUM_ANAHTARI ? html`
<script>window.COMPEC_OLCUM={anahtar:${ham(JSON.stringify(OLCUM_ANAHTARI))},sunucu:${ham(JSON.stringify(OLCUM_SUNUCU))},surum:"v5-isik"${s.kisi ? ham(`,kisi:${JSON.stringify('uye-' + s.kisi.id)},rol:${JSON.stringify(s.kisi.rol)}`) : ''}};</script>
