...
${OLCUM_ANAHTARI ? html`
<script>window.COMPEC_OLCUM={anahtar:${ham(JSON.stringify(OLCUM_ANAHTARI))},sunucu:${ham(JSON.stringify(OLCUM_SUNUCU))},surum:"v2-matbaa"${s.kisi ? ham(`,kisi:${JSON.stringify('uye-' + s.kisi.id)},rol:${JSON.stringify(s.kisi.rol)}`) : ''}};</script>
...
<header class="tepe">
  <div class="kap tepe-ic">
    <a class="arma" href="${u('/')}">
      <img src="${u('/genel/varliklar/logo/compec-mark-mavi.png')}" alt="" width="789" height="439">
      <b>Compec</b>
      <span>Boğaziçi Üniversitesi<br>Bilişim Kulübü</span>
    </a>
...
<footer class="dip">
  <div class="kap">
    <div class="dip-izgara">
      <div class="dip-arma">
        <img src="${u('/genel/varliklar/logo/compec-lockup-mavi.png')}" alt="Compec" width="793" height="637">
