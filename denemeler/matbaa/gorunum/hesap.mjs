  ...
  <div class="kap">
    ...
    <div class="panel-izgara">
      ...
      <div>
        ...
        ${bekleyen.length === 0
          ? html`<p style="color:var(--murekkep-2);margin-bottom:40px">Bekleyen başvuru yok.</p>`
                ...
                <td colspan="2">
                  <form method="post" action="${u('/panel/yonetim/baglanti')}" style="display:flex;gap:8px">
                    ...
                    <input name="linkedin" value="${t.linkedin || ''}" placeholder="linkedin.com/in/..."
                           style="flex:1;font-family:var(--mono);font-size:12.5px;padding:6px 9px;border:1px solid var(--cizgi-koyu);border-radius:3px">
  ...
  <div class="kap">
    ...
    <div class="panel-izgara">
      ...
      <div>
        ...
        ${ozet.length === 0
          ? html`<p style="color:var(--murekkep-2)">Henüz oy verilmemiş.</p>`
